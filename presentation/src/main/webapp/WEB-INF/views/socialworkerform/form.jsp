...
<button type="submit" style="width:200px;" onclick="window.open( contextPath + '/patient/history/<c:out value="${socialWorkerForm.patient.id}"></c:out>', 'GEEE', 'width=500,height=500' )" class="button-text button-delete fg-button ui-state-default ui-corner-all"><span class="ui-icon ui-icon-arrow-1-n button-icon"></span>Abrir Historia del paciente</button>
...
<form:form modelAttribute="socialWorkerForm" method="post" id="myform">
		...
		<table width="100%">
			...
			<tr>
				...
				<tr>
					<td><form:label for="fatherFirstName" path="fatherFirstName" cssErrorClass="error"><fmt:message key="socialworker.form.fatherFirstName" /></form:label>
						<form:input path="fatherFirstName" tabindex="1" /> <form:errors path="fatherFirstName" /></td>
					<td><form:label for="fatherLastName" path="fatherLastName" cssErrorClass="error"><fmt:message key="socialworker.form.fatherLastName" /></form:label>
						<form:input path="fatherLastName" tabindex="2" /> <form:errors path="fatherLastName" /></td>
					<td><form:label for="fatherAge" path="fatherAge" cssErrorClass="error"><fmt:message key="socialworker.form.fatherAge" /></form:label>
						<form:input path="fatherAge" tabindex="3" /> <form:errors path="fatherAge" /></td>
					</tr>
			<tr>
				...
				<tr>
					<td><form:label for="motherFirstName" path="motherFirstName" cssErrorClass="error"><fmt:message key="socialworker.form.motherFirstName" /></form:label>
						<form:input tabindex="4" path="motherFirstName" /> <form:errors path="motherFirstName" /></td>
					<td><form:label for="motherLastName" path="motherLastName" cssErrorClass="error"><fmt:message key="socialworker.form.motherLastName" /></form:label>
						<form:input tabindex="5" path="motherLastName" /> <form:errors path="motherLastName" /></td>
					<td><form:label for="motherAge" path="motherAge" cssErrorClass="error"><fmt:message key="socialworker.form.motherAge" /></form:label>
						<form:input tabindex="6" path="motherAge" /> <form:errors path="motherAge" /></td>
					</tr>
			<tr>
				...
				<tr>
					<td><form:label for="tutorFirstName" path="tutorFirstName" cssErrorClass="error"><fmt:message key="socialworker.form.tutorFirstName" /></form:label>
						<form:input tabindex="7" path="tutorFirstName" /> <form:errors path="tutorFirstName" /></td>
					<td><form:label for="tutorLastName" path="tutorLastName" cssErrorClass="error"><fmt:message key="socialworker.form.tutorLastName" /></form:label>
						<form:input tabindex="8" path="tutorLastName" /> <form:errors path="tutorLastName" /></td>
					<td><form:label for="tutorAge" path="tutorAge" cssErrorClass="error"><fmt:message key="socialworker.form.tutorAge" /></form:label>
						<form:input tabindex="9" path="tutorAge" /> <form:errors path="tutorAge" /></td>
					</tr>
			<tr>
				...
				<c:forEach var="livesWith" items="${livesWith}">
					<c:if test="${count%fieldsPerRow == 0 }"><tr></c:if>
						<td><form:radiobutton tabindex="1${count}" path="livesWith" value="${livesWith}" />
			...
			<tr>
				<td colspan="${fieldsPerRow}">
					...
					<form:input tabindex="20" path="peopleAtHome" /> <form:errors path="peopleAtHome" /></td></tr>
			<tr>
				<td colspan="${fieldsPerRow}">
					...
					<form:input tabindex="21" path="peopleAtHomeOverTen" /> <form:errors path="peopleAtHomeOverTen" /></td></tr>
			<tr>
				<td colspan="${fieldsPerRow}">
					...
					<form:input tabindex="22" path="peopleAtHomeUnderTen" /> <form:errors path="peopleAtHomeUnderTen" /></td></tr>
	...
	<div id="tab-viv" class="socialworkerform">
		<table>
			...
			<tr>
				...
				<form:input tabindex="23" path="roomsExcludingKitchenAndBathroom" /> <form:errors path="roomsExcludingKitchenAndBathroom" /></td></tr>
			<tr>
				...
				<c:forEach var="interiorFloor" items="${interiorFloor}">
					<c:if test="${count%fieldsPerRow == 0 }"><tr></c:if>
						<td><form:radiobutton tabindex="${count+24}" path="interiorFloor" value="${interiorFloor}" /> 
			...
			<tr>
				...
				<c:forEach var="roofType" items="${roofType}">
					<c:if test="${count%fieldsPerRow == 0 }"><tr></c:if>
						<td><form:radiobutton tabindex="${count+27}" path="roofType" value="${roofType}" /> 
			...
			<tr>
				...
				<form:checkbox tabindex="34" path="hasCeiling" /> <form:errors path="hasCeiling" /></td></tr>
			<tr>
				...
				<c:forEach var="waterSource" items="${waterSource}">
					<c:if test="${count%fieldsPerRow == 0 }"><tr></c:if>
						<td><form:radiobutton tabindex="${count+35}" path="waterSource" value="${waterSource}" /> 
			...
			<tr>
				...
				<c:forEach var="waterSourceType" items="${waterSourceType}">
					<c:if test="${count%fieldsPerRow == 0 }"><tr></c:if>
						<td><form:radiobutton tabindex="${count+38}" path="waterSourceType" value="${waterSourceType}" /> 
			...
			<tr>
				<td><form:label for="hasBathroom1" path="hasBathroom" cssErrorClass="error"> <span class="titleform"><fmt:message key="socialworker.form.hasBathroom" /></span></form:label>
					<form:checkbox tabindex="40" path="hasBathroom" /> <form:errors path="hasBathroom" /></td></tr>
			<tr>
				<td><form:label for="bathroomInside1" path="bathroomInside" cssErrorClass="error"><span class="titleform"><fmt:message key="socialworker.form.bathroomInside" /> </span></form:label>
					<form:checkbox tabindex="41" path="bathroomInside" /> <form:errors path="bathroomInside" /></td></tr>
			<tr>
				...
				<c:forEach var="bathroomSewerType" items="${bathroomSewerType}">
					<c:if test="${count%fieldsPerRow == 0 }"><tr></c:if>
						<td><form:radiobutton tabindex="${count+42}" path="bathroomSewerType" value="${bathroomSewerType}" /> 
			...
			<tr>
				...
				<form:checkbox tabindex="45" path="inSinkingZone" /> <form:errors path="inSinkingZone" /></td></tr>
			<tr>
				...
				<c:forEach var="kitchenFuel" items="${kitchenFuel}">
					<c:if test="${count%fieldsPerRow == 0 }"><tr></c:if>
						<td><form:radiobutton tabindex="${count+46}" path="kitchenFuel" value="${kitchenFuel}" /> 
			...
			<tr>
				...
				<c:forEach var="electricity" items="${electricity}">
					<c:if test="${count%fieldsPerRow == 0 }"><tr></c:if>
						<td><form:radiobutton tabindex="${count+49}" path="electricity" value="${electricity}" /> 
		...
		<table width="100%">
			...
			<tr>
				<td colspan="${fieldsPerRow}"><form:label for="knowsHowToReadAndWrite1" path="knowsHowToReadAndWrite" cssErrorClass="error"><span class="titleform"><fmt:message key="socialworker.form.knowsHowToReadAndWrite" /></span></form:label>
					<form:checkbox tabindex="52" path="knowsHowToReadAndWrite" /> <form:errors path="knowsHowToReadAndWrite" /></td></tr>
			<tr>
				<td colspan="${fieldsPerRow}"><form:label for="goingToSchool1" path="goingToSchool" cssErrorClass="error"><span class="titleform"><fmt:message key="socialworker.form.goingToSchool" /></span></form:label>
					<form:checkbox tabindex="53" path="goingToSchool" /> <form:errors path="goingToSchool" /></td></tr>
			<tr>
				...
				<c:forEach var="scholarity" items="${scholarity}">
					<c:if test="${count%fieldsPerRow == 0 }"><tr></c:if>
						<td><form:radiobutton tabindex="${count+54}" path="scholarity" value="${scholarity}" />
			...
			<tr>
				...
				<c:forEach var="schoolHours" items="${schoolHours}">
					<c:if test="${count%fieldsPerRow == 0 }"><tr></c:if>
						<td><form:radiobutton tabindex="${count+59}" path="schoolHours" value="${schoolHours}" />
			...
			<tr>
				...
				<c:forEach var="schoolService" items="${schoolService}">
					<c:if test="${count%fieldsPerRow == 0 }"><tr></c:if>
						<td><form:radiobutton tabindex="${count+63}" path="schoolService" value="${schoolService}" />
		...
		<table>
			...
			<tr>
				<td colspan="${fieldsPerRow}"><form:label for="workingPeople1" path="workingPeople" cssErrorClass="error"><span class="titleform"><fmt:message key="socialworker.form.workingPeople" /></span></form:label>
					<form:input path="workingPeople" tabindex="66" /> <form:errors path="workingPeople" /></td></tr>
			<tr>
				...
				<c:forEach var="adultEducationalLevel" items="${adultEducationalLevel}">
					<c:if test="${count%fieldsPerRow == 0 }"><tr></c:if>
						<td><form:radiobutton tabindex="${count+67}" path="adultEducationalLevel" value="${adultEducationalLevel}" />
			...
			<tr>
				...
				<c:forEach var="mainIncome" items="${mainIncome}">
					<c:if test="${count%fieldsPerRow == 0 }"><tr></c:if>
						<td><form:radiobutton tabindex="${count+73}" path="mainIncome" value="${mainIncome}" />
			...
			<tr>
				...
				<c:forEach var="nbi" items="${nbi}">
					<c:if test="${count%fieldsPerRow == 0 }"><tr></c:if>
						<td><form:checkbox tabindex="${count+77}" path="nbi" value="${nbi}" />
			...
			<tr>
				...
				<c:forEach var="addiction" items="${addiction}">
					<c:if test="${count%fieldsPerRow == 0 }"><tr></c:if>
						<td><form:checkbox tabindex="${count+82}" path="addiction" value="${addiction}" />
			...
			<tr>
				...
				<c:forEach var="mistreatment" items="${mistreatment}">
					<c:if test="${count%fieldsPerRow == 0 }"><tr></c:if>
						<td><form:checkbox tabindex="${count+86}" path="mistreatment" value="${mistreatment}" />
			...
			<tr>
				<td colspan="${fieldsPerRow}"><form:label for="hasProfessionalAssistanceForMistreatment1" path="hasProfessionalAssistanceForMistreatment" cssErrorClass="error"><span class="titleform"><fmt:message key="socialworker.form.hasProfessionalAssistanceForMistreatment" /></span></form:label>
					<form:checkbox tabindex="88" path="hasProfessionalAssistanceForMistreatment" /> <form:errors path="hasProfessionalAssistanceForMistreatment" /></td></tr>
			<tr>
				<td colspan="${fieldsPerRow}"><form:label for="hasHealthCare1" path="hasHealthCare" cssErrorClass="error"><span class="titleform"><fmt:message key="socialworker.form.hasHealthCare" /></span></form:label>
					<form:checkbox tabindex="89" path="hasHealthCare" /> <form:errors path="hasHealthCare" /></td></tr>
			...
			<tr>
				...
				<td colspan="${fieldsPerRow}"><form:label for="hasBeenDerivedToOtherSocialServices1" path="hasBeenDerivedToOtherSocialServices" cssErrorClass="error"><span class="titleform"><fmt:message key="socialworker.form.hasBeenDerivedToOtherSocialServices" /></span></form:label>
					<form:checkbox tabindex="90" path="hasBeenDerivedToOtherSocialServices" /> <form:errors path="hasBeenDerivedToOtherSocialServices" /></td></tr>
			<tr>
			...
			<tr>
				<td colspan="${fieldsPerRow}"><form:textarea tabindex="91" path="diagnose" /><form:errors path="diagnose" /></td></tr>
			<tr>
			...
			<tr>	
				<td colspan="${fieldsPerRow}"><form:textarea tabindex="92" path="observations" /><form:errors path="observations" /></td></tr>
	...
	<div class="form-save-button">
		<input id="formSubmitBtn" tabindex="93" type="submit" value="Guardar Formulario" onClick="_isDirty = false;"/>
	</div>
